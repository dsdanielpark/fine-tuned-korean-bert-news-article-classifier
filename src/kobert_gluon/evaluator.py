...
#     def _mxnet_inference(model: object, data_iter: DataLoader, save_path:str, ctx=ctx) -> (list, list):
...
#     def make_infer_result_df(model_path, target_data_f_path, result_save_f_path, mode, num_cluster):
...
#         df_eval = _mxnet_inference(model, test_dataloader, None, ctx=ctx) 
